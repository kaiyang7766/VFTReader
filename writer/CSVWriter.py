...
from writer.ReportWriter import ReportWriter
import csv, os


class CSVWriter(ReportWriter):
    """A writer class that writes extracted VFT reports to a .csv file
    """

    def write(self, reportList: List[VFTReport], filepath:str):
        ...
        with open(filepath , "w", newline='') as outf:
            ...
            outf.close()
    def update(self, newReport: VFTReport, originalReportPath: str):
